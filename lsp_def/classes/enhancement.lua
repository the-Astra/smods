...
---@field always_scores? boolean Enhanced cards always score. May be overridden by `context.modify_scoring_hand` effects.
---@field never_scores? boolean Enhanced cards never score. Takes priority over `always_scores`. May be overridden by `context.modify_scoring_hand` effects.
---@field shatters? boolean Enhanced cards use a shatter animation when destroyed.
