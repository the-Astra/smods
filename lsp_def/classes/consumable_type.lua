...
---@field primary_colour? Color HEX color used as the primary color. Set as `G.C.SET[self.key]`. 
---@field secondary_colour? Color HEX color used as the seconary color. Set as `G.C.SECONDARY_COLOUR[self.key]`. 
